import { mergeProps, useSSRContext, onMounted, onUnmounted, computed, ref, unref, withCtx, renderSlot, createVNode, createTextVNode, openBlock, createBlock, toDisplayString, createCommentVNode } from "vue";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$2, {
        href: _ctx.route("reports.analytics"),
      ...
      _push(ssrRenderComponent(_sfc_main$2, {
        href: _ctx.route("activity.index"),
      ...
      _push(ssrRenderComponent(_sfc_main$2, {
        ...
        active: _ctx.route().current("notifications.*"),
        class: "relative"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Notifications `);
            if (_ctx.$page.props.auth.unreadNotificationsCount > 0) {
              _push2(`<span class="absolute -top-1 -right-4 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-red-100 transform translate-x-1/2 -translate-y-1/2 bg-red-600 rounded-full"${_scopeId}>${ssrInterpolate(_ctx.$page.props.auth.unreadNotificationsCount)}</span>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
            return [
              ...
              _ctx.$page.props.auth.unreadNotificationsCount > 0 ? (openBlock(), createBlock("span", {
                key: 0,
                class: "absolute -top-1 -right-4 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-red-100 transform translate-x-1/2 -translate-y-1/2 bg-red-600 rounded-full"
              }, toDisplayString(_ctx.$page.props.auth.unreadNotificationsCount), 1)) : createCommentVNode("", true)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_sfc_main$1, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (_ctx.$page.props.auth.unreadNotificationsCount > 0) {
              _push2(`<span class="inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-red-100 bg-red-600 rounded-full"${_scopeId}>${ssrInterpolate(_ctx.$page.props.auth.unreadNotificationsCount)}</span>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
